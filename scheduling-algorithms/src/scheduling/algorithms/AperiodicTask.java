...
public class AperiodicTask extends Task {   
     ...
     */
    public AperiodicTask(float arrivalTime, float computationTime){
        super(computationTime, Float.MAX_VALUE);        
     ...
     */
    public AperiodicTask(float arrivalTime, float computationTime, float deadline){
        super(computationTime, deadline);
        this.arrivalTime = arrivalTime;
    }
